...
public class Audi extends Cars {
   ...
   // private String model;
    ...
    public void showAvailableCars(boolean isActive){
        System.out.println();
        System.out.println("*******************     OUR VEHICLES AVAILABLE          ***********************  \n");
    ...
    public void showInactiveCars(boolean isActive){
        System.out.println();
        System.out.println("*************************     OUR UNAVAILABLE VEHICLES      ***************************** \n");
        System.out.printf("%-13s  %-10s  %-13s  %-10s  %-14s  %-12s %-15s\n","Vehicle Code\",\"Brand name\",\"Model\",\"Model Year\",\"Automatic Transmission\",\"Fuel Type\",\"Daily Price");
        System.out.printf("%-13s  %-10s  %-13s  %-10s  %-14s  %-12s %-15s\n","-----------","--------","---------","----------","--------------","----------","------------");
        for (Audi w :audiList){
